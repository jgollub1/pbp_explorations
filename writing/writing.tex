...
\While {$|$currentProb - prob$| \textgreater \epsilon $}:
...
%Since elo outperformed Klaassen and Magnus' combined player outcome model in pre-match prediction, it makes sense test a version of the hierarchical Markov Model that uses an elo forecast as its starting point.
